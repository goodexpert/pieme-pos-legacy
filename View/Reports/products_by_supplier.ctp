...
<!-- FILTER -->
<form class="col-md-12 col-xs-12 col-sm-12 line-box filter-box" action="/reports/sales/products_by_supplier"
      method="get">
    ...
    <div class="scroll-table">
      <table class="table-bordered dataTable">
          ...
          <?php foreach ($products as $product) {
            ...
            if ($count > 0) { ?>
              <tr>
                ...
                <td class="text-right"><?php if ($sales > 0) {
                    echo number_format(($sales - $cost) / $sales * 100, 2, '.', ',');
                  } else {
                    echo 0;
                  } ?></td>
            ...
            if ($len == $i) { ?>
              <tr class="table-color">
                ...
                <td class="text-right"><?php if ($totalSales > 0) {
                    echo number_format(($totalSales - $totalCost) / $totalSales * 100, 2, '.', ',');
                  } else {
                    echo "0.00";
                  } ?></td>
        ...
        <tr class="table-color">
          ...
          <td class="text-right"><?php if ($grandTotalSales > 0) {
              echo number_format(($grandTotalSales - $grandTotalCost) / $grandTotalSales * 100, 2, '.', ',');
            } else {
              echo 0;
            } ?></td>
