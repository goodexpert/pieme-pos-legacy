		...
		<div class="page-content">
			...
			<div class="col-md-12 col-xs-12 col-sm-12 line-box filter-box new-inventory margin-top-20">
                <div class="col-md-4 col-xs-4 col-sm-4">
                    <dl>
                    	...
                    	<dd>
                            <select class="status">
                            	<option value="active">Main Outlet</option>
                       		</select>
                    	</dd>
					</dl>
				</div>
                ...
                <div class="col-md-8 col-xs-8 col-sm-8 margin-top-20">
                	<dl>
                        ...
                        <dd style="width: 81%;"><input type="text"></dd>
                    </dl>
                 </div>
			...
			<div class="col-md-12 margin-top-20 col-omega">
              ...
              <div class="pull-right">
                <button type="button" class="btn btn-primary btn-wide cancel margin-right-10">Save</button>
