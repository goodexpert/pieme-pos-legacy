...
<div class="col-md-12 col-xs-12 col-sm-12 line-box filter-box new-inventory margin-top-20">
  ...
  <div
      class="text-center margin-top-10 inline-block full-count" <?php echo $full_count == 1 ? '' : 'style="display:none;"'; ?>>
    <p class="background-text"><h5>All products will be counted</h5></p>
  </div>
  <div
      class="col-md-12 col-xs-12 col-sm-12 product-search-container" <?php echo $full_count == 0 ? '' : 'style="display:none;"'; ?>>
    <div class="col-md-12 col-xs-12 col-sm-12">
      <h5><strong>Partial Count List</strong></h5>
      <h5>Create your list of items to count using suppliers, brands, types, tags, or SKUs. Combine multiple filters to
        narrow down your list.</h5>
      <input type="text" class="margin-top-20" id="search-items"
        ...
        <div class="filter-tag-group">
          ...
          <div class="filter-tag-items">
                                <span class="filter-tag-item">
                                  ...
                                  <a class="filter-tag-item-remove clickable" data-type="<?php echo $filter['type']; ?>"
                                     data-value="<?php echo $filter['value']; ?>" onclick="removeFilter(this);">
    ...
    <div class="col-md-12 col-xs-12 col-sm-12 margin-bottom-20">
      ...
      <div
          class="no-list text-center margin-top-20" <?php echo count($products) == 0 ? '' : 'style="display:none;"'; ?>>
...
<div class="col-md-12 margin-bottom-20 col-omega">
  ...
  <div class="pull-right">
    <button type="submit"
            class="btn btn-primary btn-wide margin-right-10 save" <?php echo $can_save ? '' : 'disabled="disabled"'; ?>>
      Save
    </button>
    <button type="submit" class="btn btn-success btn-wide start" <?php echo $can_save ? '' : 'disabled="disabled"'; ?>>
      Start
    </button>
  </div>
</div>
