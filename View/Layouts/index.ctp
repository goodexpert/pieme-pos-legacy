...
<!-- BEGIN HEAD -->
<head>
    <title data-ng-bing="ONZSA | <?php echo $this->fetch('title'); ?>"></title>
    ...
    <link href="/theme/metronic/assets/global/css/components.css" id="style_components" rel="stylesheet" type="text/css"/>
    ...
    <link href="/theme/metronic/assets/admin/layout/css/themes/darkblue.css" rel="stylesheet" type="text/css" id="style_color"/>
...
<body ng-controller="AppController" class="page-header-fixed page-sidebar-closed-hide-logo page-quick-sidebar-over-content page-on-load" ng-class="{'page-container-bg-solid': settings.layout.pageBodySolid, 'page-sidebar-closed': settings.layout.pageSidebarClosed}">
    ...
    <script src="/theme/metronic/assets/global/plugins/angularjs/angular.min.js" type="text/javascript"></script>    
    <script src="/theme/metronic/assets/global/plugins/angularjs/angular-sanitize.min.js" type="text/javascript"></script>
    <script src="/theme/metronic/assets/global/plugins/angularjs/angular-touch.min.js" type="text/javascript"></script>    
    <script src="/theme/metronic/assets/global/plugins/angularjs/plugins/angular-ui-router.min.js" type="text/javascript"></script>
    <script src="/theme/metronic/assets/global/plugins/angularjs/plugins/ocLazyLoad.min.js" type="text/javascript"></script>
    ...
    <script src="/theme/metronic/assets/admin/layout/scripts/demo.js" type="text/javascript"></script>  
