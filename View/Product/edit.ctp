...
<div class="clearfix"></div>
  ...
  <form action="<?php echo $_SERVER['REQUEST_URI'];?>" class=" box product-add product-form" method="post" id="product-form" enctype="multipart/form-data">
    <div class=" form">
      <!-- BEGIN FORM-->
          ...
          <div class="col-md-12 col-xs-12 col-sm-12 col-alpha col-omega">
              <div class="set-price col-md-12">
                ...
                <div class="set-price-box col-md-2 col-xs-2 col-sm-2 col-alpha">
                  ...
                  <input type="hidden" id="retail_price_exclude_hidden" value="<?=number_format($product['MerchantProduct']['price'],5,'.','');?>">
                  <div class="info">Excluding tax</div>
                </div>
                <div class="set-price-box col-md-3 col-xs-3 col-sm-3 col-alpha">
                  ...
                  <input type="hidden" id="sales_tax_calc_hidden" class="textOnly" value="<?=$product['MerchantProduct']['tax'];?>" disabled>
                ...
                <div class="set-price-box col-md-3 col-xs-3 col-sm-3 col-alpha col-omega">
                  ...
                  <input type="hidden" id="retail_price_include_hidden" value="<?=$product['MerchantProduct']['price']+$product['MerchantProduct']['tax'];?>">
  ...
  $(document).on('click', '.editProduct', function () {
    ...
    if ($(".incorrect").length == 0) {
      ...
      $(".stock-tracking").each(function () {
        inventories.push({
          outlet_id: $(this).find(".stock-outlet_id").val(),
          count: $(this).find(".stock_count").val(),
          reorder_point: $(this).find(".stock_reorder_point").val(),
          restock_level: $(this).find(".stock_reorder_amount").val()
        })
      });
      var composite = [];
