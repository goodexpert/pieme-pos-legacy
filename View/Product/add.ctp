            ...
            <div class="form-body line-box line-box-content col-md-12 col-xs-12 col-sm-12 col-alpha col-omega"> 
              ...
              <div class="col-md-12 col-xs-12 col-sm-12 col-alpha col-omega"> 
                ...
                <div class="col-md-6">
                  ...
                  <dl class="form-group">
                    <dt class="col-md-3">Account code</dt>
                    <dd class="col-md-9">
                ...
                <div class="col-md-6">
                  ...
                  <dl class="form-group">
                    <dt class="col-md-3">Purchasing code</dt>
                    <dd class="col-md-9">
                      <input type="text" class="form-control" id="Purchasing_code">
                    </dd>
                  </dl>
                </div>
                <!-- END col-md-6--> 
              ...
              <div class="col-md-12 col-xs-12 col-sm-12 col-alpha col-omega margin-top-20"> 
                ...
                <div class="col-md-6">
                  <dl class="form-group">
                    ...
                    <dd class="col-md-9">
                      <input type="text" class="form-control required" id="product_handle">
