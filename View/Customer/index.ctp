...
<div id="add_customer_box" class="pop-hide">
    <input type="hidden" value="" class="type_id_add">
    Type name <input type="text" class="type_name_add"><br>
    <input type="button" value="add" class="type_add">
    <input type="button" value="edit" class="type_edit">
    <input type="button" value="cancel" class="add_type_box_close">
</div>
<!-- END CONTAINER -->
