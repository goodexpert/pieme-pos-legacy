        ...
        <dd>
          <div class="col-md-6 col-sm-6 col-xs-6 col-alpha">
            <input type="text" placeholder="First" class="name_first"
                   value="<?php echo $customer['Contact']['first_name']; ?>">
          </div>
          <div class="col-md-6 col-sm-6 col-xs-6 col-omega col-alpha">
            <input type="text" placeholder="Last" class="name_last"
                   value="<?php echo $customer['Contact']['last_name']; ?>">
          </div>
        </dd>
        <dt>Company</dt>
        <dd><input type="text" class="company_name" value="<?php echo $customer['Contact']['company_name']; ?>"></dd>
        <dt>Customer code</dt>
        <dd><input type="text" class="customer_code pull-left required"
                   value="<?php echo $customer['MerchantCustomer']['customer_code']; ?>"></dd>
        ...
        <dd>
          <div class="col-md-6 col-sm-6 col-xs-6 col-alpha">
            <input type="radio" id="female" value="F"
                   name="gender" <?php if ($customer['MerchantCustomer']['gender'] == 'F') {
              echo "checked";
            } ?>><label for="female"> Female</label>
          </div>
          <div class="col-md-6 col-sm-6 col-xs-6 col-alpha">
            <input type="radio" id="male" value="M"
                   name="gender" <?php if ($customer['MerchantCustomer']['gender'] == 'M') {
              echo "checked";
  ...
  <div class="col-md-12 col-sm-12 col-xs-12 margin-top-20 col-alpha col-omega">
    <div class="line-box col-md-12 col-sm-12 col-xs-12">
      <div class="col-md-6 col-sm-6 col-xs-6">
        ...
        <dl>
          <dt>Street</dt>
          <dd><input type="text" class="physical_street_1"
                     value="<?php echo $customer['Contact']['physical_address1']; ?>"></dd>
          <dt>Street</dt>
          <dd><input type="text" class="physical_street_2"
                     value="<?php echo $customer['Contact']['physical_address2']; ?>"></dd>
          <dt>Suburb</dt>
          <dd><input type="text" class="physical_suburb" value="<?php echo $customer['Contact']['physical_suburb']; ?>">
          </dd>
          <dt>City</dt>
          <dd><input type="text" class="physical_city" value="<?php echo $customer['Contact']['physical_city']; ?>">
          </dd>
          <dt>Physical postcode</dt>
          <dd><input type="text" class="physical_postcode"
                     value="<?php echo $customer['Contact']['physical_postcode']; ?>"></dd>
          <dt>State</dt>
          <dd><input type="text" class="physical_state" value="<?php echo $customer['Contact']['physical_state']; ?>">
          </dd>
          <dt>Country</dt>
          <dd>
      ...
      <div class="col-md-6 col-sm-6 col-xs-6">
        ...
        <dl>
          <dt>Street</dt>
          <dd><input type="text" class="postal_street_1" value="<?php echo $customer['Contact']['postal_address1']; ?>">
          </dd>
          <dt>Street</dt>
          <dd><input type="text" class="postal_street_2" value="<?php echo $customer['Contact']['postal_address2']; ?>">
          </dd>
          <dt>Suburb</dt>
          <dd><input type="text" class="postal_suburb" value="<?php echo $customer['Contact']['postal_suburb']; ?>">
          </dd>
          <dt>City</dt>
          <dd><input type="text" class="postal_city" value="<?php echo $customer['Contact']['postal_city']; ?>"></dd>
          <dt>Physical postcode</dt>
          <dd><input type="text" class="postal_postcode" value="<?php echo $customer['Contact']['postal_postcode']; ?>">
          </dd>
          <dt>State</dt>
    ...
    <div class="line-box col-md-12 col-sm-12 col-xs-12">
      <div class="col-md-6 col-sm-6 col-xs-6">
        <dl>
          ...
          <dd><input type="text" class="customer_field_1"
                     value="<?php echo $customer['MerchantCustomer']['user_field_1']; ?>"></dd>
          <dt>Custom Field 2</dt>
          <dd><input type="text" class="customer_field_2"
                     value="<?php echo $customer['MerchantCustomer']['user_field_2']; ?>"></dd>
          <dt>Custom Field 3</dt>
          <dd><input type="text" class="customer_field_3"
                     value="<?php echo $customer['MerchantCustomer']['user_field_3']; ?>"></dd>
          <dt>Custom Field 4</dt>
          <dd><input type="text" class="customer_field_4"
                     value="<?php echo $customer['MerchantCustomer']['user_field_4']; ?>"></dd>
        </dl>
      </div>
      <div class="col-md-6 col-sm-6 col-xs-6">
        <dl>
          <dt>Note</dt>
          <dd><textarea class="customer_note" rows="5"
                        style="width:100%;"><?php echo $customer['MerchantCustomer']['note']; ?></textarea></dd>
        </dl>
      </div>
    </div>
  </div>
