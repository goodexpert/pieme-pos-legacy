        ...
        <div class="page-content">
            ...
            <div class="line-box line-box-content col-md-12 col-sm-12 col-xs-12">
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <dl>
                        ...
                        <dt>Description</dt>
                        <dd><textarea style="width:100%;" id="supplier_desc"><?=$supplier['MerchantSupplier']['description'];?></textarea></dd>
                    </dl>
                </div>
            </div>
            ...
            <div class="line-box line-box-content col-md-12 col-sm-12 col-xs-12">
                <div class="col-md-6 col-sm-12 col-xs-12" style="border-right:1px solid #eee;">
                    <dl>
                        ...
                        <dt>Contact name</dt>
                        <dd><input type="text" style="width:49%;" placeholder="First" id="first_name" value="<?=$supplier['Contact']['first_name'];?>">
                        <input type="text" class="pull-right" style="width:49%;" placeholder="Last" id="last_name" value="<?=$supplier['Contact']['last_name'];?>"></dd>
            ...
            <div class="line-box line-box-content col-md-12 col-sm-12 col-xs-12">
                <div class="col-md-6 col-sm-12 col-xs-12">
                    ...
                    <dl>
                        <dt>Street</dt>
                        <dd><input type="text" class="physical_street_1" value="<?=$supplier['Contact']['physical_address1'];?>"></dd>
                        <dt>Street</dt>
                        <dd><input type="text" class="physical_street_2" value="<?=$supplier['Contact']['physical_address2'];?>"></dd>
                        <dt>Suburb</dt>
                        ...
                        <dd><input type="text" class="physical_postcode" value="<?=$supplier['Contact']['physical_postcode'];?>"></dd>
                        <dt>State</dt>
