...
<div class="col-md-12 col-xs-12 col-sm-12 col-alpha col-omega">
  ...
  <div class="pull-right col-md-5 col-xs-5 col-sm-5 col-alpha col-omega margin-top-20">
    ...
    <a href="/product/<?= $id; ?>/edit">
      <button id="import" class="btn btn-white pull-right btn-left">
  ...
  <div class="col-md-9 col-xs-9 col-sm-9 col-alpha col-omega margin-top-20">
    ...
    <div class="col-md-12 col-xs-12 col-sm-12 col-alpha col-omega">
      ...
      <dl class="col-md-6 col-xs-6 col-sm-6 col-alpha">
        ...
        <dd class="col-md-8">
          <span
              class="product_average_cost"><?php echo number_format($product['MerchantProduct']['supply_price'], 2, '.', ','); ?></span>
        </dd>
      </dl>
    </div>
    <span class="dashed-line-gr"></span>
...
<!-- END col-md-12-->
<!-- filter-->
<form class="col-md-12 col-xs-12 col-sm-12 line-box filter-box margin-top-20"
  ...
  <div class="col-md-4 col-xs-4 col-sm-4">
    <dl>
      ...
      <dd>
        ...
        <input type="text" id="Period_start" name="from" value="<?php if (isset($_GET['from'])) {
          echo $_GET['from'];
        } ?>">
      </dd>
      <dt>User</dt>
  ...
  <div class="col-md-4 col-xs-4 col-sm-4">
    <dl>
      ...
      <dd>
        <span class="glyphicon glyphicon-calendar icon-calendar"></span>
        <input type="text" id="Period_end" name="to" value="<?php if (isset($_GET['to'])) {
          echo $_GET['to'];
        } ?>">
      </dd>
      <dt>Outlet</dt>
