    ...
    if (null != response.message) {
      ...
      if ('Display' == messageType) {
        ...
        if("PRESENT/INSERT" == text1) {
          $(".display-msg").empty();
          $(".display-msg").append('<p>' +a + '</p>');
          $(".display-msg").append('<div><img style="width: 50%" class="payment-img" src ="../img/payment/icon-01.png"></img></div>');
        }
        else if("AWAITING ACCOUNT" == text1 ||"PROCESSING NOW" == text1 ||"AWAITING PIN" == text1){
          $(".display-msg").empty();
          $(".display-msg").append(text1 +' ' + text2 );
          $(".display-msg").append('<div><img style="width: 50%" class="payment-img" src ="../img/payment/icon-02.png"></img></div>');
        }
        else if ("ACCEPTED" == text1 ||"SIG ACCEPTED" == text1 ) {
          $(".display-msg").empty();
          $(".display-msg").text(text1 +' '+ text2);
          $(".display-msg").append('<div><img style="width: 50%" class="payment-img" src ="../img/payment/icon-03.png"></img></div>');
        }
        else if ("INCORRECT PIN" == text1) {
          $(".display-msg").empty();
          $(".display-msg").text(text1 +' '+ text2);
          $(".display-msg").append('<div><img style="width: 50%" class="payment-img" src ="../img/payment/icon-05.png"></img></div>');
        }
        ...
        //IF transaction cancelled
          ...
          $(".display-msg").empty();
          $(".display-msg").text(text1 +' '+ text2);
          $(".display-msg").append('<img src ="../img/payment/icon-06.png"></img>');
          ...
          $(".display-msg").empty();
          $(".display-msg").append('<p>' +a + '</p>');
          $(".display-msg").append('<div><img style="width: 50%" class="payment-img" src ="../img/payment/icon-04.png"></img></div>');
        }
